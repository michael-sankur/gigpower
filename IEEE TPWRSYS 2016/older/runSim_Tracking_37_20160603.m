...
feeder.name = 'feeder37_ieee_journal';
...
controllers.wmax = 1.5*controllers.wmax;
controllers.wmaxpu = 1.5*controllers.wmaxpu;
...
for kpath = 1:size(feeder.paths,1)
    ...
    plot(temppath,abs(FBSbase.V(3,temppath)),'b.','MarkerSize',tn,'LineWidth',2)
    ...
    plot(temppath,abs(FBSbase.V(3,temppath)),'b--','MarkerSize',tn,'LineWidth',1.5)
end
...
for kpath = 1:size(feeder.paths,1)
    ...
    plot(temppath,abs(FBSd3f.V(3,temppath)),'b.','MarkerSize',tn,'LineWidth',2)
    ...
    plot(temppath,abs(FBSd3f.V(3,temppath)),'b--','MarkerSize',tn,'LineWidth',1.5)
end
for k1 = 2:n
...
for kpath = 1:size(feeder.paths,1)
    ...
    plot(temppath,180/pi*angle(FBSbase.V(3,temppath))-120,'b.','MarkerSize',tn,'LineWidth',2)
    ...
    plot(temppath,180/pi*angle(FBSbase.V(3,temppath))-120,'b--','MarkerSize',tn,'LineWidth',1.5)
end
set(gca,'XTick',1:n,'XTickLabel',feeder.nodelist,'FontSize',15,'FontWeight','bold')
...
for kpath = 1:size(feeder.paths,1)
    ...
    plot(temppath,180/pi*angle(FBSd3f.V(3,temppath))-120,'b.','MarkerSize',tn,'LineWidth',2)
    ...
    plot(temppath,180/pi*angle(FBSd3f.V(3,temppath))-120,'b--','MarkerSize',tn,'LineWidth',1.5)
end
for k1 = 2:n
...
plot(1:len,abs(FBSbase.V(3,temppath)),'b.','MarkerSize',tn,'LineWidth',2)
...
plot(1:len,abs(FBSbase.V(3,temppath)),'b--','MarkerSize',tn,'LineWidth',1.5)
plot(1:n,0.95*ones(n),'k--','MarkerSize',12,'LineWidth',2)
...
plot(1:len,abs(FBSd3f.V(3,temppath)),'b.','MarkerSize',tn,'LineWidth',2)
...
plot(1:len,abs(FBSd3f.V(3,temppath)),'b--','MarkerSize',tn,'LineWidth',1.5)
plot(1:n,0.95*ones(n),'k--','MarkerSize',12,'LineWidth',2)
set(gca,'XTick',1:len,'XTickLabel',feeder.nodelist(temppath),'FontSize',15,'FontWeight','bold')
% title('Voltage Profile of Base (No Control) Case','FontSize',15,'FontWeight','bold')
...
plot(1:len,180/pi*angle(FBSbase.V(3,temppath))-120,'b.','MarkerSize',tn,'LineWidth',2)
...
plot(1:len,180/pi*angle(FBSbase.V(3,temppath))-120,'b--','MarkerSize',tn,'LineWidth',1.5)
...
plot(1:len,180/pi*angle(FBSd3f.V(3,temppath))-120,'b.','MarkerSize',tn,'LineWidth',2)
...
plot(1:len,180/pi*angle(FBSd3f.V(3,temppath))-120,'b--','MarkerSize',tn,'LineWidth',1.5)
