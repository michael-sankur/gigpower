function [CVXRES, Eopt, Topt, Vopt, Iopt, Sopt, wopt, dopt, sopt] = parse_CVX_output(X,nvar,network)

% Michael Sankur - msankur@lbl.gov
% 2018.01.01

% This function parses the optimization variable X and returns the optimal
% network states.
...
% dopt - node complex loads in 3 x nnode matrix
