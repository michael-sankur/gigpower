function [sdpsol,SDPMAT] = Solver_SDP_singlephase_magref(feeder, nodes, lines, configs, loads, caps, controllers, sim)
%%
...
%     -trace(PhiVa(:,:,tn)*Xsdp) + vref^2 <= gammasdp;
    ...
    [gammasdp (trace(PhiVa(:,:,tn)*Xsdp) - vref^2);
        (trace(PhiVa(:,:,tn)*Xsdp) - vref^2) 1] >= 0;
