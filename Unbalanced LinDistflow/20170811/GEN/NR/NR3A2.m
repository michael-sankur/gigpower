function [VNRA2, STXNRA2, SRXNRA2] = NR3A2(feeder,nodes,lines,configs,loads,caps,controllers,Vopt,Iopt,emeas,subidx,Vnom)
...
%     FTA2(b)
    ...
    FTA2 = computeFTrealA2(XNRA2,feeder,nodes,lines,configs,loads,caps,controllers,emeas,subidx,Vnom);

    JTA2 = computeJTrealA2(XNRA2,feeder,nodes,lines,configs,loads,caps,controllers,emeas,subidx);
