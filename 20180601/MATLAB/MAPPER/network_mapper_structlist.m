...
for k1 = 1:nline
    ...
    if lines.PH(1,k1) == 0
        lines.FZpu(1,:,k1) = 0; lines.FZ(:,1,k1) = 0;
    end
    if lines.PH(2,k1) == 0
        lines.FZpu(2,:,k1) = 0; lines.FZ(:,2,k1) = 0;
    end
    if lines.PH(3,k1) == 0
        lines.FZpu(3,:,k1) = 0; lines.FZ(:,3,k1) = 0;
    end
...
for k1 = 1:size(capacitorlinearray,2)
    ...
    for k2 = 1:length(temp1)    
        ...
        caps2(k1).nodename = nodes.nodelist(knode);
        caps2(k1).node = knode;
