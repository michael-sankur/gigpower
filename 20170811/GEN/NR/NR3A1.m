function [VNRA1, STXNRA1, SRXNRA1] = NR3A1(feeder,nodes,lines,configs,loads,caps,controllers,Vopt,Iopt,subidx,Vnom)
...
FTA1 = 1e99;
iter = 0;
while max(abs(FTA1)) > 1e-9
    
%     [a b] = max(abs(FTA1))
%     FTA1(b)

    FTA1 = computeFTrealA1(XNRA1,feeder,nodes,lines,configs,loads,caps,controllers,subidx,Vnom);

    JTA1 = computeJTrealA1(XNRA1,feeder,nodes,lines,configs,loads,caps,controllers,subidx);
