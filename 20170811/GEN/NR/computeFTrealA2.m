function FT = computeFTrealA2(X,feeder,nodes,lines,configs,loads,caps,controllers,emeas,slackidx,slackVnom)
...
for ph = 1:3
    for k1 = 1:nline
        ...
        elseif LPH(ph,k1) == 1
            ...
            FTANG(end+1,1) = emeas(ph,lines.TXnum(k1))*emeas(ph,lines.RXnum(k1))*(-X(idxDm) + X(idxDn)) ...
