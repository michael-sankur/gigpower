function [nvar, Aineq, bineq, Aeq, beq, Aw, bw] = createCVXMatrixFeasible(feeder, nodes, lines, configs, loads, caps, controllers, sim)
%%
...
for ph = 1:3
    for k1 = 1:nnode
        if controllers.wmaxpu(ph,k1) ~= 0
            ...
            Aw = [Aw;
                zeros(ncirc+1,(ph-1)*nvar), zeros(ncirc+1,5*nnode) tempu tempv, zeros(ncirc+1,(3-ph)*nvar)];
            bw = [bw;
