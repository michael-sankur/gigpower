...
%% Mesh 09 Node parameters

loads1.spu = 0.5*loads1.spu;

caps1.cappu = 1*caps1.cappu;

controllers1.wmaxpu = 2*2*1.25*controllers1.wmaxpu;
...
cvx_begin quiet
    ...
    minimize(1000*Zmag2 + 10000*Zang2 + 1*Zw2)
    subject to;
    Aeq1 * X2 == beq1;
    Aineq1 * X2 <= bineq1;
%     for ph = 1:3
...
[VNR0, INR0, STXNR0, SRXNR0] = NR3(feeder1,nodes1,lines1,configs1,loads1,caps1,controllers1,[],[],1,Vnom1);

controllers1.wpu = 1*wopt1;

[VNR1, INR1, STXNR1, SRXNR1] = NR3(feeder1,nodes1,lines1,configs1,loads1,caps1,controllers1,Vopt1,Iopt1,1,Vnom1);

controllers1.wpu = 1*wopt2;

[VNR2, INR2, STXNR2, SRXNR2] = NR3(feeder1,nodes1,lines1,configs1,loads1,caps1,controllers1,Vopt1,Iopt1,1,Vnom1);
...
loads2.aPQ = 0.85*ones(3,nnode2).*nodes2.PH;
loads2.aI = zeros(3,nnode2);
loads2.aZ = 0.15*ones(3,nnode2).*nodes2.PH;
...
%% Mesh 09 Node paramters

loads2.spu = 0.5*loads2.spu;

caps2.cappu = 1*caps2.cappu;

controllers2.wmaxpu = 0.25*controllers2.wmaxpu;
...
% 
% [VNR3, INR3, STXNR3, SRXNR3] = NR3(feeder2,nodes2,lines2,configs2,loads2,caps2,controllers2,[],[],1,Vnom2);
% 
% controllers2.wpu = wopt1;
% 
% [VNR4, INR4, STXNR4, SRXNR4] = NR3(feeder2,nodes2,lines2,configs2,loads2,caps2,controllers2,[],[],1,Vnom2);
% 
% controllers2.wpu = wopt2;
% 
% [VNR5, INR5, STXNR5, SRXNR5] = NR3(feeder2,nodes2,lines2,configs2,loads2,caps2,controllers2,[],[],1,Vnom2);
