...
def fbs(network: Network) -> Solution:
    ...
    on a dss file
    Output: A Solution object, with V and I calculated.
    Note that you will need to run get_solution() to obtain sV, S, and Inode.
    """
    ...
    solution.tolerance = abs((solution.Vref[1]) * 10**-1)  # set tolerance with phase B reference voltage
